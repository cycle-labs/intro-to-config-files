...
Background:
If I assign values from config file "parameterizedTest/local.conf" to variables
Elsif I assign values from config file "parameterizedTest/default.conf" to variables
EndIf
